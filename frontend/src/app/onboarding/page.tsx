    ...
    <div className="min-h-screen bg-stone-50 dark:bg-zinc-950 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-4 md:p-8">
        <div className="w-full max-w-xl">
          ...
          >
            <p className="text-sm uppercase tracking-[0.2em] text-muted-foreground mb-3">Welcome</p>
              ...
              >
                ...
                {currentStep === 1 && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="age" className="text-sm font-normal text-foreground">
                        Age
                      </Label>
                      <Input
                        id="age"
                ...
                {currentStep === 2 && (
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <Label htmlFor="organization" className="text-sm font-normal text-foreground">
                        Organization
                      </Label>
                      <Input
                        id="organization"
                ...
                {currentStep === 3 && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="fieldOfStudy" className="text-sm font-normal text-foreground">
                        Field of Study
                      </Label>
                      <Input
                        id="fieldOfStudy"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="institution" className="text-sm font-normal text-foreground">
                        Institution
                      </Label>
                      <Input
                        id="institution"
                ...
                {currentStep === 4 && (
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <Label htmlFor="skills" className="text-sm font-normal text-foreground">
                        Skills
                      </Label>
                      <Input
                        id="skills"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="interests" className="text-sm font-normal text-foreground">
                        Interests
                      </Label>
                      <Input
                        id="interests"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="goals" className="text-sm font-normal text-foreground">
                        Goals
                      </Label>
                      <Textarea
                        id="goals"
